...
export default defineConfig({
  registry: {
    ...
    homepage: 'https://github.com/anthonymengottii/components_library',
    authors: ['Anthony Mengotti'],
    bugs: 'https://github.com/anthonymengottii/components_library/issues',
    repository: 'https://github.com/anthonymengottii/components_library',
    tags: [
      'react',
      'javascript',
      'components',
