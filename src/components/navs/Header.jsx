        ...
        {TOOLS.map(tool => (
          ...
          >
            <Flex
              ...
              boxShadow={tool.comingSoon ? 'none' : `0 2px 8px rgba(111, 148, 241, 0.4)`}
            >
        ...
        <Drawer.Body p={0}>
          <Flex direction="column">
            <Flex align="center" justify="space-between" h="57px" px={6} mb={6} borderBottom="1px solid #ffffff1c">
              <Text fontSize="xl" fontWeight="900" letterSpacing="-0.5px" color="white">
                Components Library
              </Text>
              <IconButton
    ...
    <Box zIndex={100} className="main-nav">
      <Flex className="nav-items" h={20} alignItems="center" justifyContent="space-between" px={4}>
        <RouterLink to="/" className="logo" style={{ textDecoration: 'none' }}>
          <Text fontSize="22px" fontWeight="900" letterSpacing="-1px" color="white" className="cursor-target">
            Components Library
          </Text>
        </RouterLink>
