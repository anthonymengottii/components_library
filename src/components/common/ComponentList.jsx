...
const PILL_BTN_STYLE = {
  ...
  _hover: { borderColor: 'rgba(255,255,255,0.15)', background: 'rgba(2, 11, 16, 0.55)' },
};
      ...
      >
        ...
        >
          <Text fontSize={{ base: '16px', md: '24px' }} fontWeight="600" color="#fff" letterSpacing={'-.5px'}>
            Components Library Pro is live!
          </Text>
        ...
        >
          ...
          >
            ...
            <Select.Control>
              <Select.Trigger
                ...
                transition="border-color 0.2s ease, background 0.2s ease"
                _hover={controlsDisabled ? undefined : { borderColor: 'rgba(255,255,255,0.15)', background: 'rgba(2, 11, 16, 0.55)' }}
                w="full"
              >
          ...
          >
            <IconButton
              ...
              _hover={{ borderColor: 'rgba(255,255,255,0.15)', bg: 'rgba(2, 11, 16, 0.55)' }}
                              ...
                              <Box position="relative" borderRadius="0px" overflow="hidden">
                                ...
                                {!hasDeleteButton && hasFavoriteButton ? (
                                  <IconButton
                                    ...
                                    pointerEvents={hoveredKey === item.key ? 'auto' : 'none'}
                                    color={isSaved ? '#6f94f1' : 'rgba(255,255,255,0.85)'}
                                    onClick={e => {
                                      e.preventDefault();
                                      e.stopPropagation();
