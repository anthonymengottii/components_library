...
function buildPrompt(componentName, codeObject, propData, lang, style) {
  ...
  let prompt = `## Integrate the <${componentName} /> component from Components Library
              ...
              <Tooltip.Root openDelay={250} closeDelay={100} positioning={{ placement: 'left', gutter: 8 }}>
                <Tooltip.Trigger asChild>
                  <Box
                    ...
                    {...TAB_STYLE_PROPS}
                    w={10}
                    bg={isSaved ? 'rgba(111, 148, 241, 0.15)' : undefined}
                    border={isSaved ? '1px solid rgba(111, 148, 241, 0.25)' : TAB_STYLE_PROPS.border}
                    _hover={isSaved ? { bg: 'rgba(111, 148, 241, 0.2)' } : TAB_STYLE_PROPS._hover}
                  >
