        ...
        {mediaType === 'video' && video && (
          <>
            <Flex
              ...
              bg="rgba(111, 148, 241, 0.2)"
              onClick={isExporting ? undefined : onPlayPause}
              transition="all 0.15s"
              _hover={{ bg: isExporting ? 'rgba(111, 148, 241, 0.2)' : 'rgba(111, 148, 241, 0.4)' }}
...
const ControlButton = ({ icon: IconComponent, onClick, isActive }) => (
  <Flex
    ...
    borderRadius="4px"
    cursor="pointer"
    bg={isActive ? 'rgba(111, 148, 241, 0.2)' : 'transparent'}
    onClick={onClick}
    transition="all 0.15s"
    _hover={{ bg: isActive ? 'rgba(111, 148, 241, 0.3)' : 'rgba(255,255,255,0.1)' }}
  >
