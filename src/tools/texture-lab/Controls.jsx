...
const ToggleButton = ({ icon: IconComponent, label, onClick, flex, disabled, title, ...rest }) => (
  <Flex
    ...
    _hover={disabled ? {} : { bg: 'rgba(111, 148, 241, 0.1)', borderColor: 'var(--color-primary)' }}
    flex={flex}
    title={title}
    {...rest}
  >
      ...
      {params.texture === OVERLAY_TEXTURES.CUSTOM && (
        <>
          ...
          <Flex
            ...
            transition="all 0.15s"
            _hover={{ bg: 'rgba(111, 148, 241, 0.1)' }}
            position="relative"
            overflow="hidden"
            minH="60px"
          >
  ...
  return (
    ...
    >
      <Flex
        ...
        _hover={{ bg: 'rgba(111, 148, 241, 0.05)' }}
      >
              ...
              >
                {category.effects.map(type => (
                  <Flex
                    ...
                    transition="all 0.15s"
                    _hover={{ borderColor: 'var(--color-primary)', bg: 'rgba(111, 148, 241, 0.08)' }}
                  >
