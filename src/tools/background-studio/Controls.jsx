    ...
    <Box>
      ...
      {colors.length < maxItems && (
        <Flex
          ...
          cursor="pointer"
          gap={1.5}
          _hover={{ borderColor: 'var(--color-primary)', bg: 'var(--color-brand-10)' }}
          transition="all 0.2s"
        >
            ...
            <Box className="cli-install-section cli-mode">
              ...
              <Box className="code-wrapper" position="relative">
                ...
                <Button
                  ...
                  borderRadius="12px"
                  fontWeight={500}
                  backgroundColor={copied === 'install' ? 'var(--color-primary)' : 'var(--bg-body)'}
                  border="1px solid var(--border-primary)"
                  color={copied === 'install' ? 'black' : 'white'}
                  _hover={{ backgroundColor: copied === 'install' ? 'var(--color-primary)' : 'var(--bg-elevated)' }}
