export const BACKGROUNDS = [
  ...
  },
  {
    ...
    props: [
      ...
      { name: 'color3', type: 'color', default: '#8db3ff', label: 'Color 3' },
  ...
  },
  {
    ...
    props: [
      ...
      { name: 'color', type: 'color', default: '#8db3ff', label: 'Color' },
  ...
  },
  {
    ...
    props: [
      ...
      { name: 'gradientFrom', type: 'color', default: 'rgba(111, 148, 241, 0.35)', label: 'Gradient From' },
