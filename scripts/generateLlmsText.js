...
function buildComponentSection(category, comps) {
  ...
  const entries = Object.values(comps)
    ...
    .map(c => {
      ...
      return `- [${titleHuman}](https://github.com/anthonymengottii/components_library/${slugBase}/${kebab}): ${descriptionSentence} CLI: \`${c.name}\`.`;
    });
  return `## ${pascalToTitle(category)}\n\n${entries.join('\n')}\n`;
}

const INTRO_LINES = [
  'Components Library is an open source collection of memorable UI elements - Components, Animations, Backgrounds, and Text Animations - provided in four implementation variants: JavaScript + CSS, JavaScript + Tailwind, TypeScript + CSS, and TypeScript + Tailwind.',
...
const DOC_LINKS = [
  {
    label: 'Homepage',
    url: 'https://github.com/anthonymengottii/components_library',
    note: 'Landing page, quick presentation of the library, testimonials.'
  },
  {
    label: 'Introduction',
    url: 'https://github.com/anthonymengottii/components_library/get-started/introduction',
    note: 'Project mission and principles.'
  },
  {
    label: 'Installation',
    url: 'https://github.com/anthonymengottii/components_library/get-started/installation',
    note: 'Manual copy and CLI commands (jsrepo, shadcn).'
  },
  {
    label: 'MCP Setup',
    url: 'https://github.com/anthonymengottii/components_library/get-started/mcp',
...
const CLI_INSTRUCTIONS = {
  shadcn: {
    command: 'npx shadcn@latest add https://github.com/anthonymengottii/components_library/r/<Component>-<LANG>-<STYLE>',
    params: [
      '<LANG>: JS | TS; <STYLE>: CSS | TW',
      'Example: npx shadcn@latest add https://github.com/anthonymengottii/components_library/r/SplitText-JS-CSS'
    ]
  },
  jsrepo: {
    command: 'npx jsrepo@latest add https://github.com/anthonymengottii/components_library/r/<Component>-<LANG>-<STYLE>',
    params: [
      '<LANG>: JS | TS; <STYLE>: CSS | TW',
      'Example: npx jsrepo@latest add https://github.com/anthonymengottii/components_library/r/SplitText-JS-CSS'
    ]
  },
  notes: [
...
const MCP_LINKS = [
  {
    label: 'MCP Setup',
    url: 'https://github.com/anthonymengottii/components_library/get-started/mcp',
    note: 'How AI agents can browse/search Components Library.'
  },
